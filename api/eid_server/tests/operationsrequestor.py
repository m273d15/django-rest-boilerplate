...
from eid_server.eid_types.operationsrequestor import OperationsRequestor
...
class OperationsRequestorTests(TestCase):
    ...
    def test_valid_operationsrequestor_allowed(self):
        operationsRequestor = OperationsRequestor(
    ...
    def test_valid_operationsrequestor_required(self):
        operationsRequestor = OperationsRequestor(
            documentType=self.VALID_SELECTION_STRING_REQUIRED, 
