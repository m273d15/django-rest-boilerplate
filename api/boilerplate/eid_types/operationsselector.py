...
class OperationsSelector:
    ...
    DESCRIPTION_STRING = " has to be a non empty string containing either 'ALLOWED' or 'PROHIBITED'"
    ...
    def documentType(self, value):
        check_attributeSelection("documentType" + self.DESCRIPTION_STRING, value)
    ...
    def issuingState(self, value):
        check_attributeSelection("issuingState" + self.DESCRIPTION_STRING, value)
    ...
    def dateOfExpiry(self, value):
        check_attributeSelection("dateOfExpiry" + self.DESCRIPTION_STRING, value)
    ...
    def givenNames(self, value):
        check_attributeSelection("givenNames" + self.DESCRIPTION_STRING, value)
    ...
    def familyNames(self, value):
        check_attributeSelection("familyNames" + self.DESCRIPTION_STRING, value)
    ...
    def artisticName(self, value):
        check_attributeSelection("artisticName" + self.DESCRIPTION_STRING, value)
    ...
    def academicTitle(self, value):
        check_attributeSelection("academicTitle" + self.DESCRIPTION_STRING, value)
    ...
    def dateOfBirth(self, value):
        check_attributeSelection("dateOfBirth" + self.DESCRIPTION_STRING, value)
    ...
    def placeOfBirth(self, value):
        check_attributeSelection("placeOfBirth" + self.DESCRIPTION_STRING, value)
    ...
    def nationality(self, value):
        check_attributeSelection("nationality" + self.DESCRIPTION_STRING, value)
    ...
    def birthName(self, value):
        check_attributeSelection("birthName" + self.DESCRIPTION_STRING, value)
    ...
    def placeOfResidence(self, value):
        check_attributeSelection("selection" + self.DESCRIPTION_STRING, value)
    ...
    def residencePermitI(self, value):
        check_attributeSelection("residencePermitI" + self.DESCRIPTION_STRING, value)
    ...
    def restrictedID(self, value):
        check_attributeSelection("restrictedID" + self.DESCRIPTION_STRING, value)
    ...
    def ageVerification(self, value):
        check_attributeSelection("ageVerification" + self.DESCRIPTION_STRING, value)
    ...
    def placeVerification(self, value):
        check_attributeSelection("placeVerification" + self.DESCRIPTION_STRING, value)
