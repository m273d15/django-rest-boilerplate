...
from boilerplate.eid_types.operationsresponder import OperationsResponder
...
class OperationsResponderTests(TestCase):
    ...
    def test_valid_operationsresponder_allowed(self):
        operationsResponder = OperationsResponder(documentType=self.VALID_SELECTION_STRING_ALLOWED, 
    ...
    def test_valid_operationsResponder_prohibited(self):
        operationsResponder = OperationsResponder(documentType=self.VALID_SELECTION_STRING_PROHIBITED, 
    ...
    def test_valid_operationsresponder_required(self):
        operationsResponder = OperationsResponder(documentType=self.VALID_SELECTION_STRING_NOTONCHIP, 
